...
Submitted by: **ERINLE OLUWAKANYINSOLA**

Deployed Application (**required**): [Kudos Board Deployed Site](https://kudos-board-front-end-mio0.onrender.com/)
...
- [x] **Add New Card**
  ...
  - [x] To successfully create a new card, users must specify the following:
    ...
    - [x] A gif users can search for and select within the form using the [GIPHY APx](https://developers.giphy.com/docs/api/) (required).
...
`https://www.loom.com/share/36e746b874cd4928ae11a7608f2f32de?sid=9f77b131-29e2-4e9a-8288-6888fcbb1b48`
